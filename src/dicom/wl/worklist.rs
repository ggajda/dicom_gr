...
fn create_default_worklist(path: &Path) -> Result<Vec<WorklistItem>, Box<dyn std::error::Error>> {
...
pub fn get_worklist() -> Result<Vec<WorklistItem>, Box<dyn std::error::Error>> {
